...
import com.erp.ErpInsertMon;
import weaver.conn.RecordSetDataSource;
import weaver.general.BaseBean;
import weaver.general.Util;
import weaver.interfaces.schedule.BaseCronJob;

public class ErpInsertMonSchedule extends BaseCronJob {
    private static BaseBean bb = new BaseBean();
    com.erp.ErpInsertMon ErpInsertMon = new ErpInsertMon();
    ...
    public void execute() {
        ...
        String ErpString = " select m.object_rrn,m.material_id,m.name,t1.qty,t1.date_approved,t1.vendor_id,t1.vendor_rrn from(" +
                " select to_char(im.date_approved,'YYYY-MM') date_approved,iml.material_rrn,sum(iml.qty_movement) qty,im.vendor_id,im.vendor_rrn from inv_movement im,inv_movement_line iml" +
                ...
                " group by to_char(im.date_approved,'YYYY-MM'),iml.material_rrn,im.vendor_id,im.vendor_rrn" +
        ...
        while (erp.next()) {
            ...
            ErpInsertMon.Insert(object_rrn, material_id, name, qty, date_approved, vendor_id, vendor_rrn, "601");
